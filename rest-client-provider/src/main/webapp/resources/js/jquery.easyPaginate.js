    ...
    $.fn.easyPaginate = function(option) {
        ...
        return this.each(function() {
            ...
            function init(page) {
                ...
                p.push('<a ' + (option.currentPage > 1 ? '"  rel="1"  class="btn"' : 'class="btn disabled"') + '><span class="glyphicon glyphicon glyphicon-fast-backward"/></a>');
                p.push('<a ' + (prev > 0 ? '"  rel="' + prev + '" class="btn"' : ' class="btn disabled"') + ' ><span class="glyphicon glyphicon glyphicon-backward"/></a>');
...
//                    p.push('<a class="btn ' + (option.currentPage == option.pages ? 'btn-primary disabled current' : "") + '" rel="' + option.pages + '">' + option.pages + '</a>');
                ...
                p.push('<a ' + (next <= option.pages ? '"  rel="' + next + '" class="btn"' : ' class="btn disabled"') + ' ><span class="glyphicon glyphicon glyphicon-forward"/></a>');
                p.push('<a ' + (option.pages > option.currentPage ? '"  rel="' + option.pages + '"  class="btn"' : 'class="btn disabled"') + '><span class="glyphicon glyphicon-fast-forward"/></a>');
